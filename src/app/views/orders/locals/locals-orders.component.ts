...
@Component({
  templateUrl: 'locals-orders.component.html',
  standalone: true,
  styleUrl: 'locals-orders.component.scss',
  imports: [
    TextColorDirective,
    CardComponent,
    CardHeaderComponent,
...
export class LocalsOrdersComponents implements OnInit {
  ...
  ngOnInit(): void {
    this.ordersService.getOrdersByLocal().pipe(
      switchMap((data: any) => {
